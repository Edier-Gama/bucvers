#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\users\\ediervader\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.240\\out\\buildhook\\index.js').default({tool: 'astro'}); } catch(cjsError) { try { import('file:///c:/users/ediervader/.vscode/extensions/wallabyjs.console-ninja-1.0.240/out/buildhook/index.js').then(m => m.default.default({tool: 'astro'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
